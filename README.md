...
6. If you did everything correct, https://wobbals.github.io/sandlot/ will lead to your new docs
...
- Documentation(ReDoc): https://wobbals.github.io/sandlot/
- SwaggerUI: https://wobbals.github.io/sandlot/swagger-ui/
- Look full spec:
    + JSON https://wobbals.github.io/sandlot/swagger.json
    + YAML https://wobbals.github.io/sandlot/swagger.yaml
- Preview spec version for branch `[branch]`: https://wobbals.github.io/sandlot/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://wobbals.github.io/sandlot/ with url from the message: `Server started <url>`
